    ...
    public class StopWatch 
    {
        ...
        public void Start() 
        {
            if (_isStopWatchRunning)
                throw new InvalidOperationException("Stopwatch is running, you cannot start the stopwatch twice in a row.");
        ...
        {
            if (!_isStopWatchRunning)
                throw new InvalidOperationException("Stopwatch is not running, you cannot use stop button twice in a row.");
